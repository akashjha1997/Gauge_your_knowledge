...
public class Registration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*logic for password validation in registration*/
		...
		/*Logic for Email validation registration*/ 
		        ...
		        if ((Email == null ||  pat.matcher(Email).matches()==false ||   p.matcher(Password).matches()==false   || Email.length()>50) && ((Emp_Type!="A") ||( Emp_Type!="U")  ||  (Emp_Type!="a") || (Emp_Type!="u") )) 
		        ...
		        else if(pat.matcher(Email).matches()==true )
		        {
		        	...
		        	session.setAttribute("userid", User_Id);
		                ...
		                com.cognizant.model.Registration rModel=new com.cognizant.model.Registration(First_Name,Last_Name,em,User_Id,pass,Emp_Type);
		                if(rservice.insertUser(rModel)){
		                	 pw.write("<html><body>\r\n");
		                	pw.write("<script type=\"text/javascript\">\r\n");
		                	pw.write("alert(max_time);\r\n");
		                	 pw.write("</script>\r\n");
		                	 pw.write("</body></html>\r\n");
